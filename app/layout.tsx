...
export default function RootLayout({
	...
	return (
		<html lang="fr" className="!scroll-smooth">
			<body
				className={`${myFont.className} max-w-[52rem] mx-auto px-4 pb-28 sm:px-6 md:px-8 xl:px-12 lg:max-w-7xl antialiased text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900`}
			>
