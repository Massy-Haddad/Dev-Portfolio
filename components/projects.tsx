...
import { useHorizontalScroll } from '@/lib/horizontal-scroll'
...
// Just a helper function to repeat an array n times
const repeat = (arr, n) => Array(n).fill(arr).flat()

const state = proxy({
	clicked: null,
	urls: repeat(projectsData, 6).map((project) => project.imageUrl),
})
